...
public class MainActivity extends AppCompatActivity {
    ...
    private RecycleEventsAdapter.RecyclerViewClickListener listener1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RecyclerView recyclerView = findViewById(R.id.recyler01);
        setOnClickListener();

        //String ty="2022";

        recyclerView.setLayoutManager(new LinearLayoutManager(MainActivity.this));
        recycleEventsAdapter = new RecycleEventsAdapter(dataholder, MainActivity.this, listener1);
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot event: snapshot.child("event/"+t).getChildren()){
                ...
                recyclerView.setAdapter(new RecycleEventsAdapter(dataholder,MainActivity.this, listener1));
            }
            @Override
    ...
    private void setOnClickListener() {
        listener1 =new RecycleEventsAdapter.RecyclerViewClickListener() {
            @Override
